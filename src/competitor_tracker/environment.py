...
def get_runtime_env_names() -> dict[str, tuple[str, ...]]:
    ...
    return {
        ...
        "gdelt_max_queries_per_run": ("COMPETITOR_TRACKER_GDELT_MAX_QUERIES_PER_RUN",),
        "gdelt_min_request_interval_seconds": ("COMPETITOR_TRACKER_GDELT_MIN_REQUEST_INTERVAL_SECONDS",),
        "gdelt_cooldown_seconds": ("COMPETITOR_TRACKER_GDELT_COOLDOWN_SECONDS",),
        "gdelt_rate_limit_state_path": ("COMPETITOR_TRACKER_GDELT_RATE_LIMIT_STATE_PATH",),
